    ...
    >
      ...
      >
        <div className="Header">
          <img src={logoGradient} alt="GrowPvP Logo" />
        ...
        <div className="Info">
          <div className="List">
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                Due to the privacy policies of Growtopia, accounts above the age of
            ...
            <p className="ListItem">
              <p className="Title">
                Will my Growtopia account be safe if I use the website?
              </p>
              <p className="Text">
                Yes, we don&apos;t require your Growtopia password for you to login
                hence making your account 100% safe and secure.
              </p>
            </p>
            <p className="ListItem">
              <p className="Title">Can GrowPvP be rigged?</p>
              <p className="Text">
                GrowPvP itself has no impact on the outcome of particular games.
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                GrowPvP takes a cut of 0-10% of every game to keep the site
                functional.
              </p>
            </p>
            <p className="ListItem">
