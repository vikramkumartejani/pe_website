        ...
        <div className="Info">
          <div className="List">
            <p className="ListItem">
              ...
              <p className="Text">
                By using GrowPvP.com you agree to the following Terms of
                Service. If you do not agree with these Terms of Service, you
                are not allowed to use GrowPvP.com. You must be at least 18
            ...
            <p className="ListItem">
              ...
              <p className="Text">
                ...
                GrowPvP.com is for entertainment purposes only. GrowPvP.com does
